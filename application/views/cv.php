							...
							<tr>
								<td width="100%" style="font-size: 18px; color: #353535; text-align: center; font-weight: normal; font-family: Helvetica, Arial, sans-serif; line-height: 24px;">
									<a href="#"  style="text-decoration: none; color: #353535;">
										Escribe una breve descripción de <span style="color: #0cbb98;">tus intereses profesionales</span>, reseña tu <span style="color: #0cbb98;">experiencia profesional</span> y sube tu <span style="color: #0cbb98;">currículum</span>
									</a>
								</td>
							</tr>
								...
								<td width="100%">						
									...
									<table border="0" cellpadding="0" cellspacing="0" align="center">
										...
										<tr>
											...
											<form id="form" action="?/welcome/envia" method="post" enctype="multipart/form-data">
											<fieldset>									
											...
											<label for="exp">Tu experiencia profesional</label>
											<textarea rows="10" class="form-control" cols="80" id="exp" name="exp"></textarea>
											<label for="cv">Tu currículum</label><br />
