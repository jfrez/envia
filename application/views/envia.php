							...
							<tr>
								<td width="100%" style="font-size: 18px; color: #353535; text-align: center; font-weight: normal; font-family: Helvetica, Arial, sans-serif; line-height: 24px;">
									<a href="#"  style="text-decoration: none; color: #353535;">
										Estimado(a) <?=$name?>, seleccione su  <span style="color: #0cbb98;">área profesional</span> y a cuántos <span style="color: #0cbb98;">profesionales de reclutamiento</span> desea enviar su  <span style="color: #0cbb98;">currículum</span>
									</a>
								</td>
							</tr>
								...
								<td width="100%">						
									...
									<table border="0" cellpadding="0" cellspacing="0" align="center">
										...
										<tr>
											...
											<fieldset>									
											<label for="cat">Seleccione una categoría de empleo</label><br />
											...
											<p>
											  ...
											  <label>
											    <input type="radio" name="Profesionales" value="10" />
											    10 ($US 20)</label>
											  <br />
											  <label>
											    <input type="radio" name="Profesionales" value="20" />
											    20 ($US 35)</label>
											  <br />
											  <label>
											    <input type="radio" name="Profesionales" value="50" />
											    50 ($US 70)</label>
											  <br />
											  <label>
											    <input type="radio" name="Profesionales" value="100" />
											    100 ($US 100)</label>
											  <br />
										    </p>
